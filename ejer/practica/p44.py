...
# Lista vacía para guardar los porcentajes de crecimiento
crecimientos = []

# Recorremos desde el segundo día hasta el último
...
for i, porcentaje in enumerate(crecimientos, start=2):
